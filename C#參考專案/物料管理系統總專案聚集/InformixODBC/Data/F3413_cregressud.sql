...
drop row type regress_ado_row restrict;
create row type regress_ado_row(a int, b char(10));
...
(
    ...
    c18_bool boolean,
    c19_int8 int8, 
    c20_lvarchar lvarchar,
    c21_clob clob, 
    c22_blob blob,
    c23_row regress_ado_row, 
    c24_int_set set(int not null), 
    c25_float_list list(float not null), 
    c26_row_mset multiset(regress_ado_row not null) 
...
(
        ...
        5,
        "lvarchar value",  
        filetoclob("doledbp.sql","client"), 
        filetoblob("doledbp.sql","client"),
        "row(0, 'zero')",
        "set{1, 2, 3}",
        "list{1, 2}",
        "multiset{row(-1, 'minus'), row(1, 'plus')}"
